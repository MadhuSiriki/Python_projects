...
class Bill_App():
    def __init__(self,root):
        ...
        bg_color="#badc57"
        title=Label(self.root,text="BILLING SOFTWARE",font=("times new roman",30, 'bold'),pady=2,bd=12,bg="#badc53",fg="Black",relief=GROOVE)
        title.pack()
        conn = mysql.connect(host='localhost', user='root', password='madam', database='bill')
        print("Connected to MySQL Server version:", conn.get_server_version())
    #-----------------variables-------------
    ...
    #---------------Tax------------------
        ...
        self.grocary_Tax=StringVar()
        self.cold_drinks_Tax=StringVar()
    #--------------Customer retail detials---------
        F1=Label(self.root,text="customer Name:",font=('times new roman',15,'bold'),bd=10,fg="black",bg='#badc57')
        F1.place(x=0,y=80,relwidth=1)
        cname_lbl=Label(F1,text='Customer Details',bg=bg_color,font=('times new roman',15,'bold'))
    ...
    #-------------------Medical-----------------
        ...
        thermal_gum_lbl=Label(F2,text="Thermal Gum",font=('times new roman',16,'bold'),bg='#badc57',fg='black')
        thermal_gum_lbl.grid(row=5,column=0,padx=10,pady=10,sticky='w')
        thermal_gum_txt=Entry(F2,width=10,textvariable=self.thermal_gun,font=('times new roman',16,'bold'),bd=5,relief=GROOVE)
        thermal_gum_txt.grid(row=5,column=1,padx=10,pady=10)

    #---------------------Grocery--------------------------
        F3=LabelFrame(self.root, text="Grocery", font=('times new roman', 15, 'bold'), bd=10, fg='black',bg='#badc57')
        ...
        sprite_txt = Entry(F4, width=10, textvariable=self.sprit, font=('times new roman', 16, 'bold'), bd=5,
                           relief=GROOVE)
        ...
        m5_txt = Entry(F6, width=18, textvariable=self.grocary_Tax, font='arial 10 bold', bd=7, relief=GROOVE)
    ...
    def total(self):
        ...
        self.total_medical_price=float(self.m_h_g_p+self.m_s_p+self.m_m_p+self.m_d_p+self.m_n_p+self.m_t_g_p)
        ...
        self.grocary_Tax.set("Rs. " + str(self.g_tax))

        self.c_d_s_p = self.sprit.get() * 10
    ...
    def bill_area(self):
        ...
        #---------------------Cold Drinks---------------------
        if self.sprit.get() != 0:
            self.txtarea.insert(END, f"\n Sprite\t\t{self.sprit.get()}\t\t{self.c_d_s_p}")
        if self.limka.get() != 0:
        ...
        if self.grocary_Tax.get() != '0.0':
            self.txtarea.insert(END, f"\n Grocery Tax\t\t\t{self.grocary_Tax.get()}")
